		...
		<div class="row">
			<div class="col-sm-12">
			   ...
			   <!-- sort the representations -->
							...
							<br/>
							<h3>${model.getLocText("Related Datasets","Entités reliées")}</h3>
